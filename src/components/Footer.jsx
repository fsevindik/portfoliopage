        ...
        <div className="flex flex-col items-center">           
          <div className="flex space-x-6 mb-4">             
            ...
            <a                
              ...
              target="_blank"                
              rel="noopener noreferrer"               
              className="text-gray-400 hover:text-blue-500 transform hover:scale-110 transition-all duration-300 group"               
              aria-label="LinkedIn"             
            >               
              <div className="relative w-6 h-6 flex items-center justify-center">
                <FaLinkedin className="absolute w-6 h-6 group-hover:opacity-0 transition-all duration-300" />
                <span className="absolute w-6 h-6 flex items-center justify-center font-bold text-gray-400 hover:text-blue-500 opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 rounded-full transition-all duration-500">
                  FS
                </span>
              </div>             
            </a>             
